...
public interface Player {
    ...
    /**
     * Play a game.  An implementation should repeatedly call {@link my.battleship.Platform#shoot(int, int)} until the
     ...
     * 
     * @param platform
     *            -- the game platform to be played. 
     *               
     */
    void startGame(Platform platform);

    /**
     * Gets this player's "screen name".
     *
     * @return String of the player's screen name
     */

    String getScreenName();

    /**
     * Gets this player's real name (first and last name please).
     *
     * @return String of the player's real name
     */
    String getRealName();
