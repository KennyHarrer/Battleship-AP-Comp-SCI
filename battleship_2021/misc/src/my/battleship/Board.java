...
public class Board {
    ...
    private void initialize(String gamePropertiesFile) {
        ...
        String[] rowsCols = getProperty(gameProps, "gameBoardRowsCols", false).split("x");
        createGameBoard(Integer.parseInt(rowsCols[0].trim()), Integer.parseInt(rowsCols[1].trim()));
